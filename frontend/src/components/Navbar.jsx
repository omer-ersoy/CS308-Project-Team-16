        ...
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(21rem,28rem)] xl:items-center xl:gap-8">
          <div className="flex flex-col gap-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              >
                <span className="block text-[10px] tracking-[0.34em] text-slate-400 uppercase">
              ...
              <div className="rounded-full border border-slate-200 bg-white/80 px-3 py-1 text-[10px] tracking-[0.3em] text-slate-500 uppercase shadow-[0_12px_24px_-22px_rgba(15,23,42,0.6)]">
                Cart {cartCount}
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <nav
                className="flex flex-wrap items-center gap-2 text-[11px] tracking-[0.24em] text-slate-500 uppercase"
                aria-label="Primary"
              >
                <button
                  type="button"
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-[11px] tracking-[0.24em] text-slate-500 uppercase">
                <button
                  type="button"
                  className="rounded-full border border-transparent px-3 py-1.5 transition hover:border-slate-200 hover:bg-white hover:text-slate-800"
