...
function AuthDrawer() {
  const { authOpen, authTab, setAuthTab, isLoggedIn, closeAuth, login, logout } = useAuth();
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-6 py-6 sm:px-8">
          ...
          {isLoggedIn ? (
            <div className="space-y-6">
              <p className="text-lg text-slate-700">You are signed in.</p>
              <button
                type="button"
                onClick={logout}
            ...
            <form className="space-y-5" onSubmit={handleAuthSubmit}>
              <fieldset className="space-y-3">
                <legend className="sr-only">Sign in with</legend>
              ...
              <button
                type="submit"
                className="w-full bg-slate-900 px-4 py-3.5 text-xs font-medium tracking-[0.2em] text-white uppercase transition hover:bg-slate-700"
              >
                Log in
              </button>

              <div className="text-right">
                <button type="button" className="text-sm text-slate-600 underline underline-offset-4 hover:text-slate-900">
                  Forgot password?
                </button>
              </div>
            </form>
            ...
            <form className="space-y-4" onSubmit={handleAuthSubmit}>
              ...
              <button
                type="submit"
                className="mt-2 w-full bg-slate-900 px-4 py-3.5 text-xs font-medium tracking-[0.2em] text-white uppercase transition hover:bg-slate-700"
              >
                Sign up
              </button>
            </form>
